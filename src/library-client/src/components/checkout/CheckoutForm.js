      ...
      return (
        <span>
          <FormGroup>
            ...
            <Input type="text" name="nuid" id="nuid" onChange={e => setNuid(e.target.value)} invalid={nuidValidationError}/>
            <FormFeedback>
          ...
          <FormGroup>
            ...
            <Input type="password" name="pin" id="pin" onChange={e => setPin(e.target.value)} invalid={pinValidationError}/>
            <FormFeedback>
    ...
    <div className="pt-2">
      ...
      <Form onSubmit={handleSubmit}>
        ...
        <FormGroup>
          ...
          <Input name="barcode" id="barcode" onChange={e => setBarcode(e.target.value)}/>
        </FormGroup>
